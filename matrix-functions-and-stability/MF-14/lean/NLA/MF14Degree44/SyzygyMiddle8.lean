...
theorem syzygy_middle8_zero (alpha eta gamma s : ℂ) :
    syzygyMiddle8For alpha eta gamma s (syzygyCoefficients alpha eta gamma s) = 0 := by
  dsimp [syzygyMiddle8For, syzygyCoefficients, syzygyR5, syzygyR6,
    syzygyCoefficient1, syzygyCoefficient2, syzygyCoefficient3,
    syzygyCoefficient4, syzygyCoefficient5]
  ring

#print axioms syzygy_middle8_zero
#assert_trust kernel syzygy_middle8_zero
